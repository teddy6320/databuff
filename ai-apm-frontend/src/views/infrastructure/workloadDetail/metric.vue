...
export default class DetailMetric extends Vue {
  ...
  private async getChartData () {
    const { workloadName, workloadKind, namespaceName, clusterId, fromTime, toTime, interval } = this.queryParams
    const params = {
      query: {
        types: [],
        metric: '',
        ...
        from: [
          ...
          { left: 'kube_ownerref_name', operator: '=', right: workloadName, connector: 'AND' },
          { left: 'kube_ownerref_kind', operator: '=', right: workloadKind.toLocaleLowerCase(), connector: 'AND' },
