<template>
  <el-dialog
    ...
    :title="$t('modules.views.sysManage.group.s_4af718ba')"
  ...
  >
    <div class="mb-15 flex-h">
      ...
      <el-select v-model='params.groupId' size='small' class="flex-1">
    ...
    <div slot="footer">
      ...
      <el-button type="primary" size="small" :loading="dialogPostLoading" :disabled="!params.groupId" @click="postHandle">{{ $t('modules.components.dialog-template.s_38cf16f2') }}</el-button>
    </div>
  </el-dialog>
</template>
