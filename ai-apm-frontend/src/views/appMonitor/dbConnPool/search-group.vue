...
const PoolMetric = 'service.db.connection.pool.maxSize'
...
export default class SearchGroup extends Vue {
  ...
  get filterListInit () {
    const list = [
      ...
      {
        field: 'poolName',
        label: i18n.t('modules.views.appMonitor.dbConnPool.s_a70c4620') as string, labelKey: 'modules.views.appMonitor.dbConnPool.s_a70c4620',
        type: 'select',
