...
const PoolMetricTypes = { type1: i18n.t('modules.views.appMonitor.dbConnPool.s_6b522b81') as string, type2: i18n.t('modules.views.appMonitor.dbConnPool.s_1ab064f1') as string, type3: i18n.t('modules.views.appMonitor.objectPool.s_be3f9ead') as string }
...
export default class ObjectPool extends Vue {
