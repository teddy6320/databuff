...
const PoolMetric = 'service.http.connection.pool.maxSize'
...
export default class SearchGroup extends Vue {
  ...
  get filterListInit () {
    const list = [
      ...
      {
        field: 'poolName',
        label: i18n.t('modules.views.appMonitor.httpConnPool.s_a7ae49ed') as string, labelKey: 'modules.views.appMonitor.httpConnPool.s_a7ae49ed',
        type: 'select',
