...
export default class ServiceTable extends Vue {
  ...
  private columnConfig: any = [
    { field: 'name', label: i18n.t('modules.views.appMonitor.database.s_d5f399b9') as string, labelKey: 'modules.views.appMonitor.database.s_d5f399b9', slot: 'column-name', minWidth: 150 },
    ...
    { field: 'reqRate', prop: 'reqRate', label: i18n.t('modules.views.appMonitor.database.s_77045982') as string, labelKey: 'modules.views.appMonitor.database.s_77045982', unit: 'count', lessZeroOneKey: 'callCnt', minWidth: 100, suffix: i18n.t('modules.views.appMonitor.database.s_40b291ad') as string, type: 'progress', sortable: true },
    ...
    { field: 'slowPercent', prop: 'slowPercent', label: i18n.t('modules.views.appMonitor.database.s_d5f68a6d') as string, labelKey: 'modules.views.appMonitor.database.s_d5f68a6d', unit: 'percent', lessZeroOneKey: 'slowCnt', minWidth: 100, type: 'progress', progressDirection: 'horizontal', progressType: 'circle', progressStatus: 'exception', progressBarWidth: 3, progressMax: 1, sortable: true },
  ...
  private queryApi = ServiceApi.getDatabaseList
  ...
  private formatFunc (data: any) {
    data.forEach((i: any) => {
      ...
      i.slowPercent = i.callCnt ? (i.slowCnt || 0) / i.callCnt : 0;
    });
  }
