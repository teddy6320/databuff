...
const PoolMetric = 'service.thread.pool.maximumPoolSize'
...
export default class SearchGroup extends Vue {
  ...
  get filterListInit () {
    const list = [
      ...
      {
        field: 'poolName',
        label: i18n.t('modules.views.appMonitor.serviceDetail.s_46dc5c2e') as string, labelKey: 'modules.views.appMonitor.serviceDetail.s_46dc5c2e',
        type: 'select',
