<template>
  <div class="alarm-cont">
    <div class="alarm-wrapper flex-v">
      <h3 class="m-0 font-14 fw-normal flex-none">{{ $t('modules.views.appMonitor.resourceDetail.s_358b05d0') }}</h3>
  ...
  get tableQueryParams () {
    return {
      ...
      trigger: {
        ...
        resource: [decodeURIComponent(String(this.$route.query.endpoint))]
      },
    }
  }
