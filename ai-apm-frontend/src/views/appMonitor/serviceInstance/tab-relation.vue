  ...
  <div class="relation-cont">
    ...
    <div class="service-list-info">
      <db-table
        ...
        tableKey='APM_SERVICEINSTANCE_DETAIL_LIST'
        ref='listTable'>
...
export default class TabRelation extends Vue {
    ...
    switch (this.serviceListType) {
      ...
      case 'curr':
        const currColumns: any[] = [
          { field: 'serviceInstance', label: i18n.t('modules.views.appMonitor.serviceDetail.s_8124816e') as string, labelKey: 'modules.views.appMonitor.errors.s_8124816e', minWidth: 120 },
      ...
      case 'next':
        const nextColumns: any[] = [
          ...
          { field: 'reqOutCnt', label: i18n.t('modules.views.appMonitor.serviceInstance.s_38e159b4') as string, labelKey: 'modules.views.appMonitor.serviceInstance.s_38e159b4', minWidth: 120, unit: 'count' },
        ];
  ...
  private async fetchServiceRelate () {
    ...
    const params = {
      ...
      serviceInstance: this.current?.serviceInstance,
    }
  ...
  private async fetchServiceInstance () {
    if (Array.isArray(this.serviceInstanceList)) {
      const data = [...this.serviceInstanceList];
